...
<Note>
**Coming Soon: Pay in the WalletConnect SDK** — WalletConnect Pay will soon be bundled into the existing [WalletConnect Wallet SDK](https://docs.walletconnect.network/wallet-sdk/overview). If your wallet already uses the WalletConnect SDK, we recommend waiting for the upcoming release and upgrading your SDK to enable Pay functionality, rather than integrating this standalone Pay SDK.
</Note>
