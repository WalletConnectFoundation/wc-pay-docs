---
title: "WalletConnect Pay via WalletKit - JavaScript/Web"
description: "Integrate WalletConnect Pay through WalletKit for a unified payment experience in your web wallet."
sidebarTitle: "JavaScript / Web"
---

This documentation covers integrating WalletConnect Pay through WalletKit for JavaScript/Web wallets. This approach provides a unified API where Pay is built into WalletKit, simplifying the integration for wallet developers.
