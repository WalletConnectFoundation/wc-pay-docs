...
<Tip>
**Using AI for Integration?** If you're using an AI IDE or assistant to help with integration, you can provide it with our comprehensive [AI integration prompt](https://github.com/WalletConnectFoundation/wc-pay-docs/blob/main/payments/wallets/walletkit/ai-prompts/kotlin.md) for better context and guidance.
</Tip>
