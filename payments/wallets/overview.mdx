...
<video
  ...
  autoPlay
  muted
  src="/images/videos/wc-pay-getting-started.mp4"
></video>
...
5. **Collect User Data** (if required for selected option): If the selected payment option requires compliance information, display a WebView for the user to provide it
6. **Confirm Payment**: Submit signatures and complete the payment

## Testing

Test your WalletConnect Pay integration with the Point-of-Sale app in the WalletConnect Dashboard. To enable the app, configure a mock-merchant recipient address, any payments will arrive to this address and you won't lose any testing funds.
...
<video
  ...
  autoPlay
  muted
  src="/images/videos/wc-pay-testing.mp4"
></video>
...
<video
  ...
  autoPlay
  muted
  src="/images/videos/wc-pay-recommended-implementation.mp4"
></video>
