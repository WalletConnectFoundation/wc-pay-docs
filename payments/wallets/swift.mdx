...
```swift
dependencies: [
    .package(url: "https://github.com/reown-com/reown-swift", from: "{latest version}")
]
```
...
<Info>
Check the [latest release version](https://github.com/reown-com/reown-swift/releases) to find the current version.
</Info>
