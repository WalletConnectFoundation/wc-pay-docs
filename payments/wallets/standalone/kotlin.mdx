        ...
        viewModelScope.launch {
            ...
            optionsResult.onSuccess { response ->
                ...
                actionsResult.onSuccess { actions ->
                    ...
                    // Step 4: Collect data if required (via WebView)
...
7. **WebView Data Collection**: When `collectDataAction.url` is present, display the URL in a WebView rather than building native forms. The WebView handles form rendering, validation, and T&C acceptance.
