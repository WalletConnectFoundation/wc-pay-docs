...
- **A WalletConnect QR code** shown on a screen or POS device
- **A QR code you can scan with your phone camera**, which opens a payment page where you can connect your wallet with WalletConnect
